...
# Generated trajectories are linear in the joint space or in the coordinate space, depending on the pose
...
def generate_launch_description():
    class JointTrajectoryPublisher(Node):
        def __init__(self):
            ...
            self.poses = {
                '1': [-0.261, -0.322, 0.352, 2.813, -1.525, -2.79],  # Pose 1: Joint trajectory
                '2': [-0.315, -0.322, 0.352, 2.813, -1.525, -2.79],  # Pose 2: Linear trajectory
                '3': [-0.200, -0.322, 0.352, 2.813, -1.525, -2.79],  # Pose 3: Linear trajectory
                '4': [-0.200, -0.274, 0.352, 2.056, -1.552, -2.036],  # Pose 4: Joint trajectory
                '5': [-0.323, -0.274, 0.352, 2.056, -1.552, -2.036],  # Pose 5: Linear trajectory
                '6': [-0.200, -0.274, 0.352, 2.056, -1.552, -2.036]  # Pose 6: Linear trajectory
            }
        ...
        def apply_collision_objects(self):
            try:
                ...
                shelf_collision.header.frame_id = 'base_link'
