...
def process_ros2_controllers_config(context):
    ...
    src_config_path = os.path.join(
        home,
        'Workspace/swap_ws/src/ur_custom/ur_custom_moveit/config',
        robot_name
    )
    install_config_path = os.path.join(
        home,
        'Workspace/swap_ws/install/ur_custom_moveit/share/ur_custom_moveit/config',
        robot_name
    )
...
ARGUMENTS = [
    DeclareLaunchArgument('robot_name', default_value='ur3e_2fg7_l515',
...
def generate_launch_description():
    ...
    urdf_filename = 'ur3e_2fg7_l515.urdf.xacro'
