#!/bin/bash
# Single script to launch the ur3e with Gazebo, RViz, and MoveIt 2
...
ros2 launch ur_custom_gazebo ur_custom.gazebo.launch.py \
...
sleep 15
ros2 launch ur_custom_moveit move_group.launch.py &
