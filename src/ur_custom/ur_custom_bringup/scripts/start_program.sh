#!/bin/bash
# Single script to launch the ur3e driver, MoveIt 2, onrobot communication and the program launch file
# Before running the script, source the environment with: <source ~/Workspace/swap_ws/.venv/bin/activate>
# This is necessary for Ultralytics in Python
# To run it, write the next command in the terminal: <bash "path/to/bash/file">
...
# If setting mock_hardware:=true the robot will not connect to the real world
...
ros2 launch ur_custom_driver launch_nodes.py
