#!/usr/bin/env python3
"""
Launch MoveIt 2 for the ur3e robotic arm.

This script creates a ROS 2 launch file that starts the necessary nodes and services
for controlling a ur3e robotic arm using MoveIt 2. It loads configuration files,
...
def generate_launch_description():
    """
    Generate a launch description for MoveIt 2 with ur3e robot.

    This function sets up the necessary configuration and nodes to launch MoveIt 2
    for controlling a ur3e robotic arm. It includes setting up paths to config files,
    ...
    package_name_moveit_config = 'ur_custom_moveit'
